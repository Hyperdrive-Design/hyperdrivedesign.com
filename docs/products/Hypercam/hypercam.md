...
- Heat your soldering iron to the proper temperature for brass inserts
- Press one brass heat-set insert into each side of the housing
...
- Insert a Torx countersunk screw through the mount and into the heat-set insert
- Repeat for the process for the right mount
...
- Identify the two LED lights next to the lens
- Confirm the USB cable exits from the rear of the camera
...
- Guide the USB cable through the slot as the camera slides forward
...
- LEDs are visible and aligned
- USB cable exits cleanly from the rear slot
...
[Download Hypercam STL Files](/assets/products/hypercam/hypercam%20files/hypercam_stls.zip)
